...
public class NVPAPICaller
{
    ...
    public string APIUsername = "lukedarrow360-facilitator_api1.gmail.com";
    private string APIPassword = "TFUB9W2L5MJHYS8E";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AP-.93zT4rpT129TuVIpgpyNuL.3";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44368/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44368/Checkout/CheckoutCancel.aspx";

        NVPCodec encoder = new NVPCodec();
        encoder["METHOD"] = "SetExpressCheckout";
        encoder["RETURNURL"] = returnURL;
        encoder["CANCELURL"] = cancelURL;
        encoder["BRANDNAME"] = "Shopping Site Sample Application";
        ...
        using (ShoppingSite.Logic.ShoppingCartActions myCartOrders = new ShoppingSite.Logic.ShoppingCartActions())
        {
